...
public class VoidBowItem extends Item {
	public VoidBowItem() {
		super(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).durability(4062));
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					VoidBowEntity entityarrow = VoidBowEntity.shoot(world, entity, world.getRandom(), 1.5f, 10, 1);
